...
async function predictModel(xs){
    ...
    console.log(highestScore[1]);
    document.getElementById("prediction").innerText = `Prediction: ${highestScore[1]}`;//predicting digit
    document.getElementById("confidence").innerText = `Confidence: ${(highestScore[0] * 100).toFixed(2)}%`;// confidence percentage
